...
export const managementRoutes = [
  { key: 'settings', path: 'settings', fullPath: '/dashboard/settings', label: 'Settings' },
  { key: 'clients', path: 'clients', fullPath: '/dashboard/clients', label: 'Clients' },
  { key: 'orders', path: 'orders', fullPath: '/dashboard/orders', label: 'Orders' },
  { key: 'pricing', path: 'pricing', fullPath: '/dashboard/pricing', label: 'Pricing' },
  { key: 'profile', path: 'profile', fullPath: '/dashboard/profile', label: 'Profile' },
